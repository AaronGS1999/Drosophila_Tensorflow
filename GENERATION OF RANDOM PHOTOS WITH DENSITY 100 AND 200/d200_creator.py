...
splitfolders.ratio(folder, output="output",seed=np.random.random(), ratio=(.606061, 0.393939)) 

counter1 = 1
counter2 = 1
name = "d200"
carpeta = "C:/Users/"+ user +"/Desktop/GENERATION OF RANDOM PHOTOS WITH DENSITY 100 AND 200/output/train/cuts_D200/"
...
im = Image.open("C:/Users/"+ user +"/Desktop/GENERATION OF RANDOM PHOTOS WITH DENSITY 100 AND 200/output/train/cuts_D200/reconstructed_image.png")
rgb_im = im.convert('RGB')
rgb_im.save("C:/Users/"+ user +"/Desktop/GENERATION OF RANDOM PHOTOS WITH DENSITY 100 AND 200/output/train/CUTS_D200/01.JPG", quality=100)     
