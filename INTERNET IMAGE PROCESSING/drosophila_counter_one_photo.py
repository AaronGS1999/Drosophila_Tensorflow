...
def visualize(
  ...
  new_line = {"IMAGE_NAME":INPUT_IMAGENAME, "WILD":imagewildtypecount, "WHITE":imagewhitetypecount}
  global dataframe
...
path_folder = "C:/Users/" + username + "/Desktop/INTERNET  IMAGE PROCESSING"
...
image = Image.open(INPUT_IMAGENAME).convert('RGB')
...
im.save(path_folder + "/"+"processed.png")
